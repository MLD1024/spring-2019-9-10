...
final class PostProcessorRegistrationDelegate {
	...
	public static void invokeBeanFactoryPostProcessors(
		...
		if (beanFactory instanceof BeanDefinitionRegistry) {
			...
			// 遍历传过来的 beanFactoryPostProcessors
			for (BeanFactoryPostProcessor postProcessor : beanFactoryPostProcessors) {
				// 如果 beanFactoryPostProcessors 为 BeanDefinitionRegistryPostProcessor
				if (postProcessor instanceof BeanDefinitionRegistryPostProcessor) {
					// 强转成BeanDefinitionRegistryPostProcessor
					BeanDefinitionRegistryPostProcessor registryProcessor =
							(BeanDefinitionRegistryPostProcessor) postProcessor;
					// 调用 postProcessBeanDefinitionRegistry 注册bean
					registryProcessor.postProcessBeanDefinitionRegistry(registry);
					// 添加到BeanDefinitionRegistryPostProcessor集合
					registryProcessors.add(registryProcessor);
				}
				else {
					// 添加到BeanFactoryPostProcessor集合
			...
			// 1.首先获取实现PriorityOrdered接口的BeanDefinitionRegistryPostProcessor
			...
			// 2.其次获取实现Ordered接口的BeanDefinitionRegistryPostProcessor
			...
			// 3.最后获取剩下的BeanDefinitionRegistryPostProcessor
		...
		//  实现PriorityOrdered 接口的BeanFactoryPostProcessors集合
		List<BeanFactoryPostProcessor> priorityOrderedPostProcessors = new ArrayList<>();
		//  实现Ordered 接口的BeanFactoryPostProcessors集合
		List<String> orderedPostProcessorNames = new ArrayList<>();
		//  普通的BeanFactoryPostProcessors集合
