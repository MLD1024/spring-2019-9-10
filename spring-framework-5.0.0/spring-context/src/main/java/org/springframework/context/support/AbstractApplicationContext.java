...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			try {
				...
				// 设置执行自定义的BeanDefinitionRegistryPostProcessor 和spring内部自己定义的
	 ...
	 * 这个地方需要注意getBeanFactoryPostProcessors()是获取手动给spring的BeanFactoryPostProcessor<p>
	 ...
	 * 这里获取的BeanFactoryPostProcessors 只能是通过addBeanFactoryPostProcesor() 添加进来的
	 */
